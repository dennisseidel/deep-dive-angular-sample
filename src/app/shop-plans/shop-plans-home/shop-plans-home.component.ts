...
@Component({
  selector: 'app-shop-plans-home',
  templateUrl: './shop-plans-home.component.html',
  styleUrls: ['./shop-plans-home.component.css']
})
export class ShopPlansHomeComponent implements OnInit {
